...
from aioTelegramLogs.utils import escape_html

__all__ = ['BaseFormatter', 'MarkdownFormatter', 'HtmlFormatter']
...
class BaseFormatter(logging.Formatter):
    ...
    def __init__(self, fmt=None, *args, **kwargs):
        super(BaseFormatter, self).__init__(self.fmt or fmt, *args, **kwargs)
